      ...
      <main className="relative z-10 font-yaldevi">
        ...
        <div className="container px-5 mx-auto md:px-0">
          <section className="py-20">
            <div className="max-w-5xl mx-auto">
              <h2 className="mb-10 text-3xl font-semibold text-center font-montserrat">
                Optimiza el sistema de combustión de tu Chevrolet en Octubre
              </h2>
              <p className="mb-3 text-lg text-center">
                En nuestro mes aniversario, queremos celebrar contigo nuestros
                59 años. Es por ello que traemos una jornada especial de
                Limpieza de Tanque de Gasolina desde Ref. 114.
              </p>
              <p className="mb-1 text-lg text-center">
                ¿Qué incluye la jornada?:
              </p>
              <p className="mb-1 text-lg text-center">
                - Desmontar el tanque de gasolina
              </p>
              <p className="mb-1 text-lg text-center">- Sacar la gasolina</p>
              <p className="mb-1 text-lg text-center">- Limpiar el tanque</p>
              <p className="mb-1 text-lg text-center">
                - Cambiar el filtro de gasolina (incluye repuesto original)
              </p>
              <p className="mb-6 text-lg text-center">
                - Verificación estado de la bomba de gasolina y sus componentes
              </p>
              <p className="mb-1 text-lg text-center">
                Hacer la limpieza del tanque de gasolina a tu vehículo ayuda a
                alargar la vida útil de la bomba de gasolina, cuerpo de
                aceleración y en el rendimiento de la gasolina. Agenda una cita
                y pon tu Chevrolet al día en García-Tuñón Recuerda que todos
          ...
          <section className="py-20">
            <div className="max-w-5xl mx-auto">
              <h2 className="mb-10 text-3xl font-semibold text-center font-montserrat">
                Agenda tu cita para la limpieza del tanque de gasolina
              </h2>
              <p className="mb-3 text-lg text-center">
