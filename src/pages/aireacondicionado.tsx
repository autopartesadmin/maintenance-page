...
const AireAcondicionado: NextPage = () => {
  useHubspotForm({
    portalId: "19669407",
        ...
        <div className="container px-5 mx-auto md:px-0">
          <section className="py-20">
            <div className="max-w-5xl mx-auto">
              ...
              ¡Traemos sorpresas para Julio! Haz la {" "}
                <span className="text-[#FF3D00]"> revisión del aire acondicionado de tu Chevrolet GRATIS </span>
          ...
          <section className="py-20">
            <div className="max-w-5xl mx-auto">
              <h2 className="mb-10 text-3xl font-semibold text-center font-montserrat">
                Agenda tu cita para disfrutar de Julio MEGA FRÍO
              </h2>
              <p className="mb-3 text-lg text-center">
                Puedes contactarnos por cualquiera de estas vías. Tienes
                <span className="font-extrabold"> desde el 6 al 31 de julio</span> para
