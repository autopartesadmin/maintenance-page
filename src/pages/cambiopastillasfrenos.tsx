      ...
      <main className="relative z-10 font-yaldevi">
        <div className="relative bg-black">
          <img
            ...
            alt="banner"
            src="/CambiarPastillasdeFrenoChevrolet.jpg"
          />
          ...
          <div className="container absolute inset-0 flex items-center py-20 mx-auto">
            <h1 className="text-4xl font-semibold text-white font-montserrat">
              PROMOCIÓN CAMBIO DE FRENOS EN MAYO
            </h1>
          </div>
        </div>
        <div className="container px-5 mx-auto md:px-0">
          <section className="py-20">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="mb-3 text-lg text-center">
                ...
                Si la respuesta es sí ¡Es momento de chequear o cambiar las pastillas de frenos de tu Chevrolet!
              </p>
              <p className="mb-3 text-lg text-center">
                Aprovecha nuestra Jornada y obtén GRATIS la rectificación de los discos junto con revisión de
                25 puntos y lavado y aspirado de cortesía.
                Todos nuestros servicios incluyen repuestos originales, mano de obra certificada Chevrolet
                y 1 mes de garantía.
              </p>
          ...
          <section className="py-20">
            <div className="max-w-5xl mx-auto">
              <h2 className="mb-10 text-3xl font-semibold text-center font-montserrat">
                Agenda tu cita para realizar el cambio de Pastillas de Frenos
              </h2>
              <p className="mb-3 text-lg text-center">
                Puedes contactarnos por cualquiera de estas vías. Tienes hasta
                el <span className="font-extrabold">31 de mayo</span> para
