...
const politicaDePrivacidad = () => {
  return (
    <>
      <Head>
        <title>Política de Privacidad | Garcia Tuñon</title>
      </Head>
      <header>
        <SubHeader />
      </header>
      <div className="container mx-auto px-20 pb-20">
        ...
        <p className="mb-3 text-lg">
          ...
          <strong>GARCÍA-TUÑÓN</strong> usa y protege la información que es
          ...
          embargo esta <strong>Política de Privacidad</strong> puede cambiar con
        ...
        <p className="mb-3 text-lg">
          <strong>GARCÍA-TUÑÓN</strong> está altamente comprometido para cumplir
        ...
        <p className="mb-3 text-lg">
          <strong>GARCÍA-TUÑÓN</strong> Se reserva el derecho de cambiar los
